...
import {
  ...
  type ChatActiveRunsParams,
  ChatActiveRunsParamsSchema,
  type ChatActiveRunsResult,
  ChatActiveRunsResultSchema,
  type ChatEvent,
  ChatEventSchema,
...
export const validateChatActiveRunsParams = ajv.compile<ChatActiveRunsParams>(
  ChatActiveRunsParamsSchema,
);
